...
# # #girder sections
# BuildRCrectSection(101, 0.40, 0.60, 0.04, 20000, 50000, 60000, 19, 0.020, 10, 9, 10, 5, 5, 5)
# BuildRCrectSection(102, 0.40, 0.60, 0.04, 20000, 50000, 60000, 20, 0.020, 10, 10, 10, 5, 5, 5)
# BuildRCrectSection(103, 0.55, 0.70, 0.04, 30000, 50000, 60000, 30, 0.022, 15, 15, 10, 5, 5, 5)
# BuildRCrectSection(104, 0.55, 0.70, 0.04, 40000, 50000, 60000, 24, 0.022, 12, 12, 10, 5, 5, 5)
...
exec(open("shearwallsection.py").read())
# exec(open("modifiedmodel.py").read())
exec(open("RCstory3D.py").read())
# exec(open("DefineBeamLoading.py").read())
# vfo.plot_model(setview="xz")
...
dt = 0.01
ops.timeSeries('Path', 10, '-filePath', 'RSN6_IMPVALL.I_I-ELC180_IDA1.txt', '-dt', dt, '-factor', (mm / 10) * 9.86)
ops.pattern('UniformExcitation', 3, 1, '-accel', 10, '-fact', 1)

ops.timeSeries('Path', 11, '-filePath', 'RSN6_IMPVALL.I_I-ELC270_IDA2.txt', '-dt', dt, '-factor', (mm / 10) * 9.86)
ops.pattern('UniformExcitation', 4, 2, '-accel', 11, '-fact', 1)
...
# # ---------Y dir--------
recorder('Node', '-file', 'timehistory_output4/dispY9901.txt', '-timeSeries', 11, '-node', 9901, '-dof', 2, 'disp')
recorder('Node', '-file', 'timehistory_output4/dispY9902.txt', '-timeSeries', 11, '-node', 9902, '-dof', 2, 'disp')
recorder('Node', '-file', 'timehistory_output4/dispY9903.txt', '-timeSeries', 11, '-node', 9903, '-dof', 2, 'disp')
recorder('Node', '-file', 'timehistory_output4/dispY9904.txt', '-timeSeries', 11, '-node', 9904, '-dof', 2, 'disp')
recorder('Node', '-file', 'timehistory_output4/dispY9905.txt', '-timeSeries', 11, '-node', 9905, '-dof', 2, 'disp')
recorder('Node', '-file', 'timehistory_output4/dispY9906.txt', '-timeSeries', 11, '-node', 9906, '-dof', 2, 'disp')
recorder('Node', '-file', 'timehistory_output4/dispY9907.txt', '-timeSeries', 11, '-node', 9907, '-dof', 2, 'disp')
recorder('Node', '-file', 'timehistory_output4/dispY9908.txt', '-timeSeries', 11, '-node', 9908, '-dof', 2, 'disp')
recorder('Node', '-file', 'timehistory_output4/dispY9909.txt', '-timeSeries', 11, '-node', 9909, '-dof', 2, 'disp')
recorder('Node', '-file', 'timehistory_output4/dispY9910.txt', '-timeSeries', 11, '-node', 9910, '-dof', 2, 'disp')
recorder('Node', '-file', 'timehistory_output4/dispY9911.txt', '-timeSeries', 11, '-node', 9911, '-dof', 2, 'disp')
recorder('Node', '-file', 'timehistory_output4/dispY9912.txt', '-timeSeries', 11, '-node', 9912, '-dof', 2, 'disp')
recorder('Node', '-file', 'timehistory_output4/dispY9913.txt', '-timeSeries', 11, '-node', 9913, '-dof', 2, 'disp')
recorder('Node', '-file', 'timehistory_output4/dispY9914.txt', '-timeSeries', 11, '-node', 9914, '-dof', 2, 'disp')
recorder('Node', '-file', 'timehistory_output4/dispY9915.txt', '-timeSeries', 11, '-node', 9915, '-dof', 2, 'disp')
recorder('Node', '-file', 'timehistory_output4/dispY9916.txt', '-timeSeries', 11, '-node', 9916, '-dof', 2, 'disp')
recorder('Node', '-file', 'timehistory_output4/dispY9917.txt', '-timeSeries', 11, '-node', 9917, '-dof', 2, 'disp')
recorder('Node', '-file', 'timehistory_output4/dispY9918.txt', '-timeSeries', 11, '-node', 9918, '-dof', 2, 'disp')
recorder('Node', '-file', 'timehistory_output4/dispY9919.txt', '-timeSeries', 11, '-node', 9919, '-dof', 2, 'disp')
recorder('Node', '-file', 'timehistory_output4/dispY9920.txt', '-timeSeries', 11, '-node', 9920, '-dof', 2, 'disp')
recorder('Node', '-file', 'timehistory_output4/dispY9921.txt', '-timeSeries', 11, '-node', 9921, '-dof', 2, 'disp')
recorder('Node', '-file', 'timehistory_output4/dispY9922.txt', '-timeSeries', 11, '-node', 9922, '-dof', 2, 'disp')
recorder('Node', '-file', 'timehistory_output4/dispY9923.txt', '-timeSeries', 11, '-node', 9923, '-dof', 2, 'disp')
recorder('Node', '-file', 'timehistory_output4/dispY9924.txt', '-timeSeries', 11, '-node', 9924, '-dof', 2, 'disp')
recorder('Node', '-file', 'timehistory_output4/dispY9925.txt', '-timeSeries', 11, '-node', 9925, '-dof', 2, 'disp')
recorder('Node', '-file', 'timehistory_output4/dispY9926.txt', '-timeSeries', 11, '-node', 9926, '-dof', 2, 'disp')
recorder('Node', '-file', 'timehistory_output4/dispY9927.txt', '-timeSeries', 11, '-node', 9927, '-dof', 2, 'disp')
recorder('Node', '-file', 'timehistory_output4/dispY9928.txt', '-timeSeries', 11, '-node', 9928, '-dof', 2, 'disp')
recorder('Node', '-file', 'timehistory_output4/dispY9929.txt', '-timeSeries', 11, '-node', 9929, '-dof', 2, 'disp')
recorder('Node', '-file', 'timehistory_output4/dispY9930.txt', '-timeSeries', 11, '-node', 9930, '-dof', 2, 'disp')
# # ---------X dir--------
...
# Define custom control parameters (optional)
# control = {
#     'algoTypes': [40],  # Use Newton and NewtonLineSearch algorithms
# }

# 'algoTypes': [40,41,42,43,44,45,11,12,20,21,22,23,30,31,50,51,52,53,70,
#               80],  # Use Newton and NewtonLineSearch algorithms
dt = 0.001
npts = 28000
...
#         test('NormDispIncr', 1.0e-1, 250, 1)
...
#
#                   if ok != 0:
#                     print("regular time step failed .. PeriodicNewton lets try a smaller step and a less stringent test")
#                     constraints('Transformation')
#                     numberer('RCM')
#                     system('SparseGeneral')
#                     test('NormDispIncr', 1.0e-1, 250, 1)
...
#
#                     if ok != 0:
#                       print("regular time step failed .. BFGS lets try a smaller step and a less stringent test")
#                       constraints('Transformation')
#                       numberer('RCM')
#                       system('SparseGeneral')
#                       test('NormDispIncr', 1.0e-1, 250, 1)
...
#
#                     if ok != 0:
#                       print("regular time step failed .. Broyden lets try a smaller step and a less stringent test")
#                       constraints('Transformation')
#                       numberer('RCM')
#                       system('SparseGeneral')
#                       test('NormDispIncr', 1.0e-1, 250, 1)
...
#                                             numberer('RCM')
#                                             system('SparseGeneral')
#                                             test('RelativeNormDispIncr', 1.0e-1, 250, 1)
#                                             ops.algorithm(defaultAlgorithmType)
#                                             ok = analyze(1, dt * 0.0001)
#
#                                             if ok != 0:
