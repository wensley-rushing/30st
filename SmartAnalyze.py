...
def SmartAnalyzeTransient(dt,npts,ud=None):
    ...
    control['testTol']=1.0e-1
    control['testIterTimes']=500
    control['testPrintFlag']=1
    control['tryAddTestTimes']=True
    control['normTol']=1.0e10
    control['testIterTimesMore']=500
    control['tryLooseTestTol']=True
    control['looseTestTolTo']=1.0e-1
    control['tryAlterAlgoTypes']=True
    control['algoTypes']=[40]
    control['initialStep']=dt
    control['relaxation']=0.5
    control['minStep']=1.0e-15
...
def RecursiveAnalyze(step,algoIndex,testIterTimes,testTol,vcontrol,vcurrent):
    ...
    if control['debugMode']:
        print("*** SmartAnalyze: Run Recursive: step=%f, algoI=%i, times=%i, tol=%f" % (
...
def setAlgorithm(algotype):
    ...
    def case44():
        ...
        ops.algorithm('KrylovNewton',maxDim=500)

    def case45():
        print("> SmartAnalyze: Setting algorithm to  KrylovNewton -iterate initial -increment initial -maxDim 50")
        ops.algorithm('KrylovNewton',iterate='initial',increment='initial',maxDim=500)
    ...
    def case90():
        print("> SmartAnalyze: Setting algorithm to  RaphsonNewton ...")
    ...
    switch={'0': case0,'1': case1,'2': case2,'10': case10,'11': case11,'12': case12,
            ...
            '50': case50,'51': case51,'52': case52,'53': case53,'60': case60,'70': case70,'80': case80,'90': case90,
            'default': default}
